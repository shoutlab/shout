...
import ShoutlabShoutShoutlabShoutShout from './shoutlab/shout/shoutlab.shout.shout'
...
export default { 
  ...
  ShoutlabShoutShoutlabShoutShout: load(ShoutlabShoutShoutlabShoutShout, 'shoutlab.shout.shout'),
